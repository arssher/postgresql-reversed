...
/*
 * Below goes static inlined function moved from execGrouping.c
 * Obviously this is not a good place for it, but we just want to check
 * the performance without changing a lot of existing code.
 */
